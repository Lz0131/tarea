...
import 'package:tareas/features/authentication/controllers/forget_password/forget_password_controller.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              /// Imagen con el 60% del ancho de la pantalla.
              Image(
                  image: const AssetImage(TImages.deliveredEmailIllustration),
                  width: THelperFunctions.screenWidth() * 0.6),
              const SizedBox(height: TSizes.spaceBtwSections),

              /// Correo, Titulo y SubTitulo
              Text(email,
